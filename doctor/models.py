...
class Patient(models.Model):
    ...
    age = models.CharField(max_length=9,null = True,default = "0")
    ...
    diagnose = models.TextField(max_length=1000,null = True,default = None)
    treatment = models.TextField(max_length=1000,null = True,default = None)
